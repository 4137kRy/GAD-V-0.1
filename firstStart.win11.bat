...
echo ============================================================
echo  Установка голосового помощника Джарвис (Windows 11)
echo ============================================================
echo.
...
:: Попытка установки через pip, при неудаче - через pipwin для PyAudio
echo [2/3] Установка основных зависимостей...
...
echo   2. Запустите помощника через start.win11.bat
echo.
